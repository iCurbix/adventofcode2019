...
in1 = [[x[:1], int(x[1:])] for x in in1.split(',')]
in2 = [[x[:1], int(x[1:])] for x in in2.split(',')]
...
def unedue(in1):
    ...
    for a in in1:
        if a[0] == 'R':
            une.append((une[-1][1], (une[-1][1][0] + a[1], une[-1][1][1])))
        if a[0] == 'L':
            une.append((une[-1][1], (une[-1][1][0] - a[1], une[-1][1][1])))
        if a[0] == 'U':
            une.append((une[-1][1], (une[-1][1][0], une[-1][1][1] + a[1])))
        if a[0] == 'D':
            une.append((une[-1][1], (une[-1][1][0], une[-1][1][1] - a[1])))
    return une[1:]
...
def crossing(a, b):
    if (b[0][0] <= a[0][0] <= b[1][0] or b[1][0] <= a[0][0] <= b[0][0]) and \
            (a[0][1] <= b[0][1] <= a[1][1] or a[1][1] <= b[0][1] <= a[0][1]):
        print(a,b)
        if a[0][0] == a[1][0]:
...
def unedue2(in1):
    ...
    for a in in1:
        if a[0] == 'R':
            une.append((une[-1][1], (une[-1][1][0] + a[1], une[-1][1][1]), une[-1][2] + a[1]))
        if a[0] == 'L':
            une.append((une[-1][1], (une[-1][1][0] - a[1], une[-1][1][1]), une[-1][2] + a[1]))
        if a[0] == 'U':
            une.append((une[-1][1], (une[-1][1][0], une[-1][1][1] + a[1]), une[-1][2] + a[1]))
        if a[0] == 'D':
            une.append((une[-1][1], (une[-1][1][0], une[-1][1][1] - a[1]), une[-1][2] + a[1]))
    return une[1:]
...
def crossing2(a, b):
    if (b[0][0] <= a[0][0] <= b[1][0] or b[1][0] <= a[0][0] <= b[0][0]) and \
            (a[0][1] <= b[0][1] <= a[1][1] or a[1][1] <= b[0][1] <= a[0][1]):
        if a[0][0] == a[1][0]:
            return b[2] - abs(b[1][0] - a[0][0]) + a[2] - abs(a[1][1] - b[0][1])
        else:
            return a[2] - abs(a[1][0] - b[0][0]) + b[2] - abs(b[1][1] - a[0][1])
    return False
